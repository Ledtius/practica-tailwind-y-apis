function Header() {
  return (
    <>
      <header className="flex justify-between w-full p-4 bg-gray-500 shadow-2xl/5">
        <section className="flex items-center">
          <svg
            className="stroke-red-500 stroke-2 size-12"
          ...
          <h2 className="font-bold text-2xl">Ius</h2>
        </section>
